...
const STANDALONE_PREFIXES = ['/embed', '/chat-widget-demo']
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const isAuthPage = isStandalonePath(pathname)

  // Auth and standalone demo/embed pages render without app chrome
  if (isAuthPage) {
    return <>{children}</>
  }
